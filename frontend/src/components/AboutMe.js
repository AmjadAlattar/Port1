const AboutMe = ({ profile, skills }) => {
  return (
    <section id="about" className="w-full h-full py-24 px-4 bg-lightSurface text-[#0F1113]">
      <div className="max-w-6xl mx-auto flex flex-col gap-10">
        <h1 className="text-3xl uppercase tracking-[6px] font-extrabold text-center">A Story about me.</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-[1px_3px_6px_0_#110a25ff] hover:shadow-[3px_6px_10px_0_#110a25ff] transition-shadow duration-150">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {skills?.map((s) => (
              <div key={s.id} className="bg-white border border-gray-200 rounded-md p-4 text-center shadow-[1px_3px_6px_0_#110a25ff] hover:shadow-[2px_4px_6px_0_#110a25ff] transition-shadow duration-150">
